...
function M.setup_global_keymaps()
  ...
  if vim.g.sqlformatter_keybindings.format_selection then
    vim.keymap.set("v", vim.g.sqlformatter_keybindings.format_selection, function()
  ...
  if vim.g.sqlformatter_keybindings.toggle_format_on_save then
    vim.keymap.set("n", vim.g.sqlformatter_keybindings.toggle_format_on_save, function()
